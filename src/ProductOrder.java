...
public class ProductOrder
{
	...
	public boolean equals(Object other)
	{
		...
		//CHANGE THIS OMG THIS IS WHY YOUR SHIP METHOD ISN'T WORKING
		ProductOrder otherother = (ProductOrder) other; //Cast object into a productOrder to make this work
		//Best variable name btw

		if(this.orderNumber.equals(otherother.orderNumber))
			return true;

		return false; // Returns false if ordernumber string isn't equal
	}
}
